...
# NEW: build the attack object from args (returns None if --attack none)
from utils.attacks import build_attack
...
def main(args=None):
    ...
    if isinstance(dataset, ContinualDataset):
        attack = build_attack(args)  # returns None if args.attack == 'none' or not set
        train(model, dataset, args, attack=attack)
    else:
